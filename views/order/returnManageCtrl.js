                ...
                columns: [
                    {
                        ...
                        formatter: function (val, row) {
                            return "<a ui-sref='app.order.applyDetail({applyDetail:" + JSON.stringify(row) + "})'>" + row.number + " </a><br /><a ui-sref='app.order.applyDetail({applyDetail:" + JSON.stringify(row) + "})'>" + row.applName +"</a>"
                        }
                    }
                    , {
